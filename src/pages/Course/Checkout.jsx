...
function Checkout() {
  ...
  async function handleEnroll() {
    ...
    try {
      ...
      navigate("/enrollment-success", {
        state: { courseId, courseTitle: course.title, courseSlug: course.id },
      });
    } catch (err) {
  ...
  return (
    /* FIX: removed outer min-h-screen wrapper — layout handles that
       removed px-4 py-10 from inner div — layout <main> already provides padding */
    <div className="max-w-3xl mx-auto mt-20">
      {/* Breadcrumb */}
      <div className="flex items-center gap-2 text-xs text-slate-dark font-mono mb-8 flex-wrap">
        <button
        ...
        <button
          ...
          className="hover:text-slate transition-colors truncate max-w-30"
        >
          {course.title}
        </button>
        <span>/</span>
      ...
      {/* FIX: stack to single column on mobile, 5-col grid on md+ */}
      <div className="grid md:grid-cols-5 gap-6">
        ...
        <div className="md:col-span-3 space-y-5">
          ...
          <div className="glass rounded-2xl border border-border p-5 space-y-3">
            ...
            <div className="border-t border-border pt-3 flex justify-between items-center">
              ...
              <span className="text-xl font-black font-mono text-teal">৳0</span>
            </div>
            {!isFree && (
        ...
        <div className="md:col-span-2 md:mt-19 mt-0">
          <div className="glass rounded-2xl border border-border p-6 md:sticky md:top-6 space-y-4">
